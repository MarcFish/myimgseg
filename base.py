...
def get_model(img_shape=(128, 128, 3), filter_num=16):
    ...
    for l, s in layer_dict.items():
        if l == img_shape[0] // 2:
            break
        o = keras.layers.Conv2DTranspose(filters=filter_num * s, kernel_size=3, strides=2, padding="SAME")(o)
        o = keras.layers.BatchNormalization()(o)
        o = keras.layers.LeakyReLU(0.2)(o)

    o = keras.layers.Conv2DTranspose(filters=256, kernel_size=3, strides=2, padding="SAME")(o)
